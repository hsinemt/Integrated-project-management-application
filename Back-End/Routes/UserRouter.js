...
const { signup,sendVerifyOtp1,sendVerifyOtp ,verifyEmail, login, addManager, addTutor,addStudent, getAllUsers, updateStudentSkills,getProfile,logout,getStudentProfile, isUserEmailAvailable, updateUser, deleteUser} = require('../Controllers/UserController');
