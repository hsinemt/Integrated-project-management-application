              ...
              <ul>
                {SidebarDataTest?.map((mainLabel, index) => (
                  <React.Fragment key={`main-${index}`}>
                    {/* Check the user's role and show the corresponding submenu items */}
                        ...
                        <li>
                          <ul>
                            {mainLabel?.submenuItems?.map((title: any, i) => {
                              ...
                              // Show the submenu items based on the user's role
                              if (
                                (userRole === 'admin' && title.label === 'Admin') ||
                                (userRole === 'student' && title.label === 'Student') ||
                                (userRole === 'tutor' && title.label === 'Tutor') ||
                                (userRole === 'manager' && title.label === 'Manager')
                              ) {
                                return (
