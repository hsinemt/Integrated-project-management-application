...
const ForgotPassword = () => {
  ...
  const handleSubmit = async (e:any) => {
    ...
    try {
      await axios.post("http://localhost:9777/user/reset-password/", { email });

      // Redirect to the reset password page, passing the email as a query param
      navigate(`${all_routes.resetPassword}?email=${encodeURIComponent(email)}`);
    } catch (err) {
                ...
                <div className="authentication-card w-100">
                  <div className="authen-overlay-item border w-100">
                    <h1 className="text-white display-1">
                      ...
                      <br /> Powered By <br />  Hunters Group.
                    </h1>
                    ...
                    <div>
                      <p className="text-white fs-20 fw-semibold text-center">
                        Efficiently manage your Integrated  <br /> Project Evaluation.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <form className="vh-100" onSubmit={handleSubmit}>
                    <div className="vh-100 d-flex flex-column justify-content-between p-4 pb-0">
                      ...
                      <div className="mt-5 pb-4 text-center">
                        <p className="mb-0 text-gray-9">Copyright © 2025 - Hunters</p>
                      </div>
                    </div>
                  </form>
                </div>
